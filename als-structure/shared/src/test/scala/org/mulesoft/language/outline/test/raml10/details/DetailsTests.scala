//package org.mulesoft.language.outline.test.raml10.details
//
//import org.mulesoft.language.outline.test.raml10.RAML10Test
//
//class DetailsTests extends RAML10Test {
//
//    override def rootPath:String = "RAML10/details"
//
//    test("test 001") {
...
//
//    test("test 026") {
//        this.runTest("test026/api.raml", "test026/api-outline.json")
//    }
//
//    test("test 027") {
//        this.runTest("test027/api.raml", "test027/api-outline.json")
//    }
//
//    test("test 028") {
...
//
//    test("test 029") {
//        this.runTest("test029/files.raml", "test029/files-outline.json")
//    }
//
//}
