...
import org.mulesoft.language.outline.structure.structureImpl.symbol.amlbuilders.AmlDocumentModelSymbolBuilderCompanion

object AmlMetaDialectBuilderFactory extends AmfBuilderFactory {
  override protected def companion: FieldCompanionList = super.companion + AmlDocumentModelSymbolBuilderCompanion
}
