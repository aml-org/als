...
import org.mulesoft.language.outline.structure.structureImpl.symbol.webapibuilders.oasbuilders.ServerArrayFieldSymbolBuilderCompanion

trait EventedLikeBuilderFactory extends AmfBuilderFactory {

  override protected def companion: FieldCompanionList =
    super.companion + ServerArrayFieldSymbolBuilderCompanion + EventedDeclaresFieldSymbolBuilderCompanion
