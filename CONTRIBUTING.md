...
Please join the community on our GitHub repository. Also please make sure to take a look at the project documentation to see where we are headed.
...
-  If you find a bug, please search for it in the [Issues](https://github.com/aml-org/als/issues), and if it isn't already tracked,
   [create a new issue](https://github.com/aml-org/als/issues/new). Fill out the "Bug Report" section of the issue template. Even if an Issue is closed, feel free to comment and add details, it will still
   be reviewed.
...
### New Features
-  If you'd like to add new functionality to this project, describe the problem you want to solve in a [new Issue](https://github.com/aml-org/als/issues/new).
...
-  If you'd like to improve the tests, you want to make the documentation clearer, you have an
  ...
  -  If not, [open an Issue](https://github.com/aml-org/als/issues/new) to discuss the idea first.
