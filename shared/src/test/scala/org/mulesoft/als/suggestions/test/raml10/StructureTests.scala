...
class StructureTests extends RAML10Test {
  ...
  test("StructureTests duplicates"){
    this.runTest("structure/test152.raml", Set("enum:", "displayName:", "additionalProperties:", "xml:\n          ", "discriminator:", "default:", "maxProperties:", "minProperties:", "description:", "discriminatorValue:", "examples:\n          ", "facets:\n          ", "example:\n          "))
  }
  ...
  test("StructureTests schema 1"){
    this.runTest("structure/test155.raml", Set("enum:", "displayName:", "xml:\n        ", "default:", "pattern:", "description:", "maxLength:", "minLength:", "examples:\n        ", "facets:\n        ", "example:\n        ", "properties:\n        "))
  }
  ...
  test("Base URI parameter completion"){
    this.runTest("structure/test157.raml", Set("enum:", "displayName:", "type:", "xml:\n      ", "default:", "pattern:", "description:", "maxLength:", "minLength:", "examples:\n      ", "schema:", "facets:\n      ", "example:\n      ", "properties:\n      "))
  }
