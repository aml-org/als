...
//        var url = "file:///Users/munch/work/alsamf/als-suggestions/shared/src/test/resources/test/raml/test01.raml"
//
//
...
//        var position = -1
//
//        var result = platform.resolve(url,None).map(c => {
//            var ci = getPositions(c.stream.toString, "*", false);
//
//            position = ci.position
//            File.unapply(url).foreach(x=>platform.cacheResourceText(x, ci.content))
//        }).flatMap(_=>{
