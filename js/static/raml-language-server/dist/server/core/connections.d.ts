import { DetailsItemJSON, IChangedDocument, IDetailsReport, IExecutableAction, ILocation, ILogger, ILoggerSettings, IOpenedDocument, IRange, IStructureReport, IUIDisplayRequest, IValidationReport, StructureNodeJSON, Suggestion } from "../../common/typeInterfaces";
import { IServerConfiguration } from "../../common/configuration";
export { IRange, IValidationIssue, IValidationReport, IStructureReport, IOpenedDocument, IChangedDocument, StructureNodeJSON, Suggestion, ILogger, MessageSeverity, ILocation, ILoggerSettings, DetailsItemJSON, IDetailsReport, IExecutableAction, IUIDisplayRequest } from "../../common/typeInterfaces";
export { IServerConfiguration } from "../../common/configuration";
export interface IServerConnection extends ILogger {
     ...
     */
    onOpenDocument(listener: (document: IOpenedDocument) => void, unsubscribe?: boolean): any;
    /**
     ...
     * @param unsubscribe - if true, existing listener will be removed. False by default.
     */
    onCloseDocument(listener: (uri: string) => void, unsubscribe?: boolean): any;
    /**
     * Adds a listener to document completion request. Must notify listeners in order of registration.
     * @param listener
     * @param unsubscribe - if true, existing listener will be removed. False by default.
     */
    onDocumentCompletion(listener: (uri: string, position: number) => Promise<Suggestion[]>, unsubscribe?: boolean): any;
    /**
     ...
     * @param unsubscribe - if true, existing listener will be removed. False by default.
     */
    onFindReferences(listener: (uri: string, position: number) => Promise<ILocation[]>, unsubscribe?: boolean): any;
    /**
     ...
     */
    structureAvailable(report: IStructureReport): any;
    /**
     * Marks occurrences of a symbol under the cursor in the current document.
     * @param listener
     * @param unsubscribe - if true, existing listener will be removed. False by default.
     */
    onMarkOccurrences(listener: (uri: string, position: number) => Promise<IRange[]>, unsubscribe?: boolean): any;
    /**
     * Finds the set of document (and non-document files) edits to perform the requested rename.
     * @param listener
     * @param unsubscribe - if true, existing listener will be removed. False by default.
     */
    onRename(listener: (uri: string, position: number, newName: string) => IChangedDocument[], unsubscribe?: boolean): any;
    /**
     * Sets connection logger configuration.
     * @param loggerSettings
     */
    setLoggerConfiguration(loggerSettings: ILoggerSettings): any;
    /**
     ...
     * @param unsubscribe - if true, existing listener will be removed. False by default.
     */
    onDocumentDetails(listener: (uri: string, position: number) => Promise<DetailsItemJSON>, unsubscribe?: boolean): any;
    /**
     * Adds a listener to document details value change request.
     * @param listener
     * @param unsubscribe - if true, existing listener will be removed. False by default.
     */
    onChangeDetailValue(listener: (uri: string, position: number, itemID: string, value: string | number | boolean) => Promise<IChangedDocument[]>, unsubscribe?: boolean): any;
    /**
     ...
     * @param unsubscribe - if true, existing listener will be removed. False by default.
     */
    onChangePosition(listener: (uri: string, position: number) => void, unsubscribe?: boolean): any;
    /**
     * Reports new calculated details when available.
     * @param report - details report.
     */
    detailsAvailable(report: IDetailsReport): any;
    /**
     ...
     */
    onExecuteDetailsAction(listener: (uri: string, actionId: string, position?: number) => Promise<IChangedDocument[]>, unsubscribe?: boolean): void;
    /**
     ...
     */
    onCalculateEditorContextActions(listener: (uri: string, position?: number) => Promise<IExecutableAction[]>, unsubscribe?: boolean): void;
    /**
     ...
     * If not provided, the last reported by positionChanged method will be used.
     */
    onExecuteContextAction(listener: (uri: string, actionId: string, position?: number) => Promise<IChangedDocument[]>, unsubscribe?: boolean): void;
    /**
     ...
     * @param unsubscribe - if true, existing listener will be removed. False by default.
     */
    onSetServerConfiguration(listener: (configuration: IServerConfiguration) => void, unsubscribe?: boolean): any;
}
