...
export declare type IParseResult = parser.hl.IParseResult;
export declare type ILowLevelASTNode = parser.ll.ILowLevelASTNode;
/**
...
export interface IASTModifier {
     ...
     * @param node
     */
    deleteNode(node: IParseResult): any;
    /**
     * Updates text for the give node.
     * @param node
     */
    updateText(node: ILowLevelASTNode): any;
}
/**
 * Position in text.
 */
 ...
 * @param module
 */
export declare function isDisposableModule(module: IServerModule): module is IDisposableModule;
