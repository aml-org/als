import { DetailsItemJSON, IChangedDocument, IExecutableAction, ILocation, ILogger, IOpenedDocument, IRange, IStructureReport, IUIDisplayRequest, IValidationReport, StructureNodeJSON, Suggestion } from "./typeInterfaces";
import { IServerConfiguration } from "../common/configuration";
export { IValidationReport, IStructureReport, IOpenedDocument, IChangedDocument, StructureNodeJSON, Suggestion, ILogger, ILocation, IRange, ILoggerSettings, MessageSeverity, DetailsItemJSON, IDetailsReport, IExecutableAction, IUIDisplayRequest } from "./typeInterfaces";
...
export interface IClientConnection extends ILogger {
     ...
     * @param listener
     */
    onValidationReport(listener: (report: IValidationReport) => void): any;
    /**
     ...
     * @param listener
     */
    onStructureReport(listener: (report: IStructureReport) => void): any;
    /**
     * Notifies the server that document is opened.
     * @param document
     */
    documentOpened(document: IOpenedDocument): any;
    /**
     * Notified the server that document is closed.
     * @param uri
     */
    documentClosed(uri: string): any;
    /**
     * Notifies the server that document is changed.
     * @param document
     */
    documentChanged(document: IChangedDocument): any;
    /**
     ...
     * @param listener
     */
    onDetailsReport(listener: (IDetailsReport) => void): any;
    /**
     ...
     */
    onDisplayActionUI(listener: (uiDisplayRequest: IUIDisplayRequest) => Promise<any>): any;
    /**
     ...
     * @param value
     */
    changeDetailValue(uri: string, position: number, itemID: string, value: string | number | boolean): Promise<IChangedDocument[]>;
}
