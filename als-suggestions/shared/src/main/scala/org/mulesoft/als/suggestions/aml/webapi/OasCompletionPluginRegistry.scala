...
import org.mulesoft.als.suggestions.plugins.aml.webapi.oas.oas30.agenttopic.{AgentTopicCompletionRegistry, OperationAgentTopicCompletionPlugin}
...
object Oas30CompletionPluginRegistry extends OasBaseCompletionRegistry {
  ...
  override def plugins: Seq[AMLCompletionPlugin] = all ++
    AgentTopicCompletionRegistry.all
