...
class Oas30SimpleTemplateSuggestionTestByDirectory extends TemplateSuggestionByDirectoryTest {
  ...
  override def templateType: TemplateTypes = TemplateTypes.SIMPLE
