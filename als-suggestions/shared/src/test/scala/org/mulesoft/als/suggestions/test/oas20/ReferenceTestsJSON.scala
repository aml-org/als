...
class ReferenceTestsJSON extends OAS20Test {
  ...
  test("Shema reference test JSON 001") {
    this.runTest("references_json/schemas/test001.json",
                 Set("{ \"$ref\": \"#/definitions/Type1\" }", "{ \"$ref\": \"#/definitions/Type2\" }"))
  }

  test("Shema reference test JSON 002") {
    this.runTest("references_json/schemas/test002.json",
                 Set("\"$ref\": \"#/definitions/Type1\"", "\"$ref\": \"#/definitions/Type2\""))
  }

  test("Shema reference test JSON 003") {
    this.runTest("references_json/schemas/test003.json",
                 Set("\"$ref\": \"#/definitions/Type1\"", "\"$ref\": \"#/definitions/Type2\""))
  }
  ...
  test("Shema reference test JSON 011") {
    this.runTest("references_json/schemas/test011.json",
                 Set("{ \"$ref\": \"#/definitions/Type1\" }", "{ \"$ref\": \"#/definitions/Type2\" }"))
  }

  test("Shema reference test JSON 012") {
    this.runTest("references_json/schemas/test012.json",
                 Set("\"$ref\": \"#/definitions/Type1\"", "\"$ref\": \"#/definitions/Type2\""))
  }

  test("Shema reference test JSON 013") {
    this.runTest("references_json/schemas/test013.json",
                 Set("\"$ref\": \"#/definitions/Type1\"", "\"$ref\": \"#/definitions/Type2\""))
  }
  ...
  test("Shema reference test JSON 021") {
    this.runTest("references_json/schemas/test021.json",
                 Set("{ \"$ref\": \"#/definitions/Type1\" }", "{ \"$ref\": \"#/definitions/Type2\" }"))
  }

  test("Shema reference test JSON 022") {
    this.runTest("references_json/schemas/test022.json",
                 Set("\"$ref\": \"#/definitions/Type1\"", "\"$ref\": \"#/definitions/Type2\""))
  }

  test("Shema reference test JSON 023") {
    this.runTest("references_json/schemas/test023.json",
                 Set("\"$ref\": \"#/definitions/Type1\"", "\"$ref\": \"#/definitions/Type2\""))
  }
  ...
  test("Shema reference test JSON 031") {
    this.runTest("references_json/schemas/test031.json",
                 Set("{ \"$ref\": \"#/definitions/Type1\" }", "{ \"$ref\": \"#/definitions/Type2\" }"))
  }

  test("Shema reference test JSON 032") {
    this.runTest("references_json/schemas/test032.json",
                 Set("\"$ref\": \"#/definitions/Type1\"", "\"$ref\": \"#/definitions/Type2\""))
  }

  test("Shema reference test JSON 033") {
    this.runTest("references_json/schemas/test033.json",
                 Set("\"$ref\": \"#/definitions/Type1\"", "\"$ref\": \"#/definitions/Type2\""))
  }
...
//  }
  ...
  test("Response reference test JSON 001") {
    this.runTest("references_json/responses/test001.json",
                 Set("{ \"$ref\": \"#/responses/response1\" }", "{ \"$ref\": \"#/responses/response2\" }"))
  }

  test("Response reference test JSON 002") {
    this.runTest("references_json/responses/test002.json",
                 Set("\"$ref\": \"#/responses/response1\"", "\"$ref\": \"#/responses/response2\""))
  }
  ...
  test("Response reference test JSON 004") {
    this.runTest("references_json/responses/test004.json",
                 Set("\"$ref\": \"#/responses/response1\"", "\"$ref\": \"#/responses/response2\""))
  }
