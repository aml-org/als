...
class TraitReferenceTests extends RAML10Test {
  ...
  test("test001") {
    this.runTest("traitReferences/test001.raml",
      Set("[ trait1 ]","[ trait2 ]"))
  }

  test("test002") {
    this.runTest("traitReferences/test002.raml",
      Set("trait1","trait2"))
  }

  test("test003") {
    this.runTest("traitReferences/test003.raml",
        Set("trait2"))
  }

  test("test004") {
    this.runTest("traitReferences/test004.raml",
        Set("- trait1","- trait2"))
  }

  test("test005") {
    this.runTest("traitReferences/test005.raml",
        Set("trait1","trait2"))
  }

  test("test006") {
    this.runTest("traitReferences/test006.raml",
        Set("trait2"))
  }

  test("test007") {
    this.runTest("traitReferences/test007.raml",
      Set("""
            |      - trait1:
            |          param1:
            |          param2:""".stripMargin,
  ...
  test("test009") {
    this.runTest("traitReferences/test009.raml",
        Set("{ trait2: {  param1 : ,  param2 : } }"))
  }

  test("test010") {
    this.runTest("traitReferences/test010.raml",
        Set("""- trait1:
              |          param1:
              |          param2:""".stripMargin,
            """- trait2:
