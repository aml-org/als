...
import org.mulesoft.amfintegration.dialect.dialects.jsonschema.draft7.base.{BaseAnyShapeNode, BaseArrayShapeNode, BaseNodeShapeNode, BaseNumberShapeNode, BaseShapeNode, BaseStringShapeNode}
