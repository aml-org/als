...
@js.native
@JSImport("vscode-jsonrpc", "AbstractMessageType")
abstract class AbstractMessageType(_method: String, _numberOfParams: Int) extends MessageType {
...
class RequestType0[R, E, RO](method: String) extends AbstractMessageType(js.native, js.native) {
}

@js.native
@JSImport("vscode-jsonrpc", "RequestType")
class RequestType[P, R, E, RO](method: String) extends AbstractMessageType(js.native, js.native) {

}

@js.native
trait GenericRequestHandler[R, E] extends js.Function1[js.Array[js.Any], R | ResponseError[E] | Thenable[R] | Thenable[ResponseError[E]] | Thenable[R | ResponseError[E]]] {
  def apply(params: js.Any*): R | ResponseError[E] | Thenable[R] | Thenable[ResponseError[E]] | Thenable[R | ResponseError[E]]
}


@js.native
trait RequestHandler0[R, E] extends js.Function1[CancellationToken, R | ResponseError[E] | Thenable[R] | Thenable[ResponseError[E]] | Thenable[R | ResponseError[E]]] {
  def apply(token: CancellationToken): R | ResponseError[E] | Thenable[R] | Thenable[ResponseError[E]] | Thenable[R | ResponseError[E]]
}


@js.native
trait RequestHandler[P, R, E] extends js.Function2[P, CancellationToken, R | ResponseError[E] | Thenable[R] | Thenable[ResponseError[E]] | Thenable[R | ResponseError[E]]] {
  def apply(param: P, token: CancellationToken): R | ResponseError[E] | Thenable[R] | Thenable[ResponseError[E]] | Thenable[R | ResponseError[E]]
}
...
class NotificationType[P, RO](method: String) extends AbstractMessageType(js.native, js.native) {}

@js.native
@JSImport("vscode-jsonrpc", "NotificationType0")
class NotificationType0[RO](method: String) extends AbstractMessageType(js.native, js.native) {}

@js.native
@JSImport("vscode-jsonrpc", "NotificationType1")
class NotificationType1[P1, RO](method: String) extends AbstractMessageType(js.native, js.native) {}
...
trait Event[T] extends js.Function3[T => js.Any, js.Any, js.Array[Disposable], Disposable] {
  /**
    ...
    * @return
    */
  def apply(listener: T => js.Any, thisArgs: js.Any = js.native, disposables: js.Array[Disposable] = js.native): Disposable
}
