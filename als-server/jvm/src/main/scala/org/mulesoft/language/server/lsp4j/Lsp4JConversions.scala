...
import org.eclipse.lsp4j.{CompletionItem, SymbolKind, DocumentSymbol => Lsp4JDocumentSymbol, Location => Lsp4JLocation, Position => Lsp4JPosition, Range => Lsp4JRange}
...
object Lsp4JConversions {
  ...
  implicit def javaFuture[F, T](future: Future[F], convert: F => T)(implicit context: ExecutionContext): CompletableFuture[T] =
