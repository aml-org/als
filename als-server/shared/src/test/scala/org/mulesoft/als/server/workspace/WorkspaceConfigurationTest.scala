...
//            assert(config1.configuration.mainUri.isEmpty)
//            assert(config2.configuration.mainUri.contains("isolated.raml"))
//            assert(config3.configuration.mainUri.contains("isolated.raml"))
//            assert(config4.configuration.mainUri.contains("isolated.raml"))
