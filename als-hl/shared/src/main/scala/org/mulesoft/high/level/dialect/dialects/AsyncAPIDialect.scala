...
import org.mulesoft.high.level.dialect.DialectProject

import scala.collection.Map

object AsyncAPIDialect extends DialectProject {

  override val rootUrl: String = "file:///dialect6.yaml"
