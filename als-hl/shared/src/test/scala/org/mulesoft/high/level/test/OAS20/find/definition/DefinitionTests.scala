...
class DefinitionTests extends OASFindDefinitionTest {
  ...
  ignore("Schema type definition test 1 JSON. Positive") {
    var templateName = "T2"
    var templateType = "SchemaObject"
    runFindDefinitionTest("definitions/test001/spec.json",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }

  test("Schema type definition test 1 YAML. Positive") {
    var templateName = "T2"
    var templateType = "SchemaObject"
    runFindDefinitionTest("definitions/test001/spec.yml",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }

  ignore("Schema type definition test 2 JSON. Positive") {
    var templateName = "T2"
    var templateType = "SchemaObject"
    runFindDefinitionTest("definitions/test002/spec.json",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
  ...
  test("Schema type definition test 2 YAML. Positive") {
    var templateName = "T2"
    var templateType = "SchemaObject"
    runFindDefinitionTest("definitions/test002/spec.yml",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
  ...
  test("Schema type definition test 3 JSON. Positive") {
    var templateName = "T2"
    var templateType = "SchemaObject"
    runFindDefinitionTest("definitions/test003/spec.json",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
  ...
  test("Schema type definition test 3 YAML. Positive") {
    var templateName = "T2"
    var templateType = "SchemaObject"
    runFindDefinitionTest("definitions/test003/spec.yml",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
  ...
  ignore("Parameter definition test 1 JSON. Positive") {
    var templateName = "p2"
    var templateType = "ParameterObject"
    runFindDefinitionTest("parameters/test001/spec.json",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
  ...
  test("Parameter definition test 1 YAML. Positive") {
    var templateName = "p2"
    var templateType = "ParameterObject"
    runFindDefinitionTest("parameters/test001/spec.yml",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }

  ignore("Parameter definition test 2 JSON. Positive") {
    var templateName = "p2"
    var templateType = "ParameterObject"
    runFindDefinitionTest("parameters/test002/spec.json",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
  ...
  test("Parameter definition test 2 YAML. Positive") {
    var templateName = "p2"
    var templateType = "ParameterObject"
    runFindDefinitionTest("parameters/test002/spec.yml",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
  ...
  test("Parameter definition test 3 JSON. Positive") {
    var templateName = "p2"
    var templateType = "ParameterObject"
    runFindDefinitionTest("parameters/test003/spec.json",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
  ...
  test("Parameter definition test 3 YAML. Positive") {
    var templateName = "p2"
    var templateType = "ParameterObject"
    runFindDefinitionTest("parameters/test003/spec.yml",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
  ...
  ignore("Response definition test 1 JSON. Positive") {
    var templateName = "r2"
    var templateType = "ResponseObject"
    runFindDefinitionTest("responses/test001/spec.json",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
  ...
  ignore("Response definition test 2 JSON. Positive") {
    var templateName = "r2"
    var templateType = "ResponseObject"
    runFindDefinitionTest("responses/test002/spec.json",
                          x => testFindDefinitionPositive(x, templateType, templateName))
  }
