                ...
                script {
                    try {
                        if (failedStage.isEmpty()) {
                            ...
                            build job: 'ALS-New/als-client/master', parameters: [ALS_VERSION: publish_version], wait: false
                            build job: 'ALS-New/als-extension/master', parameters: [ALS_VERSION: publish_version], wait: false
                        }
                    } catch (e) {
