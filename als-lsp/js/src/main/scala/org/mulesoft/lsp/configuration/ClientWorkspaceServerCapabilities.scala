...
trait ClientWorkspaceServerCapabilities extends js.Object {
  val workspaceFolders: js.UndefOr[ClientWorkspaceFolderServerCapabilities] = js.native
  val fileOperations: js.UndefOr[ClientFileOperationsServerCapabilities]    = js.native
}
  ...
  def apply(internal: WorkspaceServerCapabilities): ClientWorkspaceServerCapabilities =
    js.Dynamic
      .literal(
        ...
        fileOperations = internal.fileOperations.map(_.toClient).orUndefined
      )
