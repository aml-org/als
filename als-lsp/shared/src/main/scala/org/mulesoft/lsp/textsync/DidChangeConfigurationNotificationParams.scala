...
/** @param mainPath
  ...
  * @param folder
  *   workspace folder uri where the project is located
  * @param dependencies
  *   if just a String, then the file will be treated as a normal lazy dependency
  */
case class DidChangeConfigurationNotificationParams(
...
/** @param file
  ...
  * @param scope
  *   type of relationship (normal dependency, custom validation, semantic extensions, etc), defaults to normal
  */
