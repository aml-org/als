...
/** Represents a diagnostic, such as a compiler error or warning. Diagnostic objects are only valid in the scope of
  ...
  * @param message            The diagnostic's severity. Can be omitted. If omitted it is up to the
  *                           client to interpret diagnostics as error, warning, info or hint.
  * @param severity           The diagnostic's code, which might appear in the user interface.
  * @param code               A human-readable string describing the source of this diagnostic,
  *                           e.g. 'typescript' or 'super lint'.
  * @param source             The diagnostic's message.
